  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        {/* Recent Orders */}
        <div className="rounded-xl border bg-card text-card-foreground shadow col-span-4 dark:border-gray-800 dark:bg-gray-800/50">
          <div className="p-6">
            <h2 className="text-lg font-semibold mb-4">Recent Orders</h2>
            <div className="space-y-4">
              {[1, 2, 3, 4, 5].map((order) => (
                <div key={order} className="flex items-center justify-between border-b pb-2 dark:border-gray-700">
                  <div>
        ...
        {/* Top Products */}
        <div className="rounded-xl border bg-card text-card-foreground shadow col-span-3 dark:border-gray-800 dark:bg-gray-800/50">
          <div className="p-6">
                ...
                <div key={index} className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <div className="h-10 w-10 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                      <span className="text-sm font-medium">{product[0]}</span>
                    </div>
                    <div>
                      <p className="font-medium">{product}</p>
                      <p className="text-sm text-muted-foreground">{Math.floor(Math.random() * 100) + 1} sold</p>
                    </div>
                  </div>
